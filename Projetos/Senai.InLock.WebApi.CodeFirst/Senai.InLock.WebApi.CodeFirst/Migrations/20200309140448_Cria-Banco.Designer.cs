...
namespace Senai.InLock.WebApi.CodeFirst.Migrations
{
    ...
    [Migration("20200309140448_Cria-Banco")]
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    ...
                    b.HasData(
                        new { IdJogo = 1, DataLancamento = new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Descrição do Diablo 3", IdEstudio = 1, NomeJogo = "Diablo 3", Valor = 99.00m },
                        new { IdJogo = 2, DataLancamento = new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Descrição do RDR II", IdEstudio = 2, NomeJogo = "Red Dead Redemption II", Valor = 120.00m }
                    );
                });
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.TiposUsuario", b =>
                {
                    ...
                    b.HasData(
                        new { IdTipoUsuario = 1, Titulo = "Admnistrador" },
